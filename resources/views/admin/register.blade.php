        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-5  demo text-body fw-bolder" style="text-align: center">Ecommerce Store</h4>


              <form  action="{{url('authRegi')}}" method="post">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit">Sign up</button><br>
